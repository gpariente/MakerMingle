...
function renderPost(posts) {
  ...
  posts.forEach((post) => {
    ...
    postDiv.className =
      "w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl m-4"; // Added margin for spacing
    ...
    descriptionP.className =
      "text-md font-semibold text-black cursor-auto my-3";
